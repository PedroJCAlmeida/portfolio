    ...
    return (
      <section id="technologies" className="w-full py-16 bg-[#121212] text-[#EAEAEA]">
        <div className="max-w-7xl w-full mx-auto px-6">
          <h2 className="text-3xl font-bold text-[#4A90E2] mb-8 text-center">Tecnologias</h2>
          <p className="mb-8 text-center">Aqui estão algumas das tecnologias com as quais trabalho:</p>
